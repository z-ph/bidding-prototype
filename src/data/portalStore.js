...
const defaultDownloads = [
  ...
  { id: 3, name: '供应商操作手册', version: 'V2026.07', updateTime: '2026-07-06', desc: '供应商注册、投标、开标全流程图文说明', category: '操作手册', content: '供应商操作手册（演示内容）\n版本：V2026.07\n更新日期：2026-07-06' },
  { id: 4, name: '招标人操作手册', version: 'V2026.07', updateTime: '2026-07-06', desc: '项目创建、公告发布、评标定标说明', category: '操作手册', content: '招标人操作手册（演示内容）\n版本：V2026.07\n更新日期：2026-07-06' },
