...
const SEED_MESSAGES = [
  ...
  },
  {
    ...
    toRole: '采购单位',
    toUser: '张三',
    title: '【审批通过】物业服务采购项目中选结果',
    content: '您提交的中选结果审批已由采购管理部审批通过，可发布中选通知。',
    type: 'approval',
    read: true,
  ...
  },
  {
    ...
    toRole: '响应单位',
    toUser: '',
    title: '【开启提醒】XX大学实验室设备采购项目今日开启',
    content: '您参与响应的「XX大学实验室设备采购项目」将于 2026-07-20 15:00 开启，请准时进入开启大厅。',
    type: 'system',
    read: false,
  ...
  },
  {
    ...
    toRole: '评审专家',
    toUser: '专家甲',
    title: '【评审任务】轨道交通电缆材料采购项目',
    content: '您已被抽取为「轨道交通电缆材料采购项目」评审委员会成员，请前往我的评审任务确认参加。',
    type: 'system',
    read: true,
