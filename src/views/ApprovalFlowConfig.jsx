...
// 2026-07-27 口径：平台仅「发布审核」一种审批单据，本页配置仅作用于发布审核。
      ...
      <Card>
        <div className="header-actions">
          <div>
            <h3>审批流配置</h3>
            <p className="tip">
              发布审核流由采购单位（采购管理部）新建、修改、启停和发布（清单 55）；平台仅发布审核一个审核点（2026-07-27 口径），不同采购方式共用同一审批流（清单 51）。
            </p>
          </div>
          {canManage && (
        ...
        <Alert
          title="发布审核链按发布者类型区分：代理提交 → 采购管理部；采购单位提交 → 需求部门 → 采购管理部。流程发布后，新提交的发布审核单按新链流转；未发布或停用的流程不作用于新发起的审批单。"
          type="info"
          showIcon
          closable={false}
          style={{ marginBottom: 16 }}
