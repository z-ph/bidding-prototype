...
const reviewData = [
  ...
  { id: 'yy0-002', source: 'yy0', module: '投标文件上传', page: 'BidUpload', severity: 'P0', issue: '上传页缺少签章、加密、重新加密、查看加密结果动作，无法闭环', status: '未修复', fix: '需按 fix-review-issues-20260714 提案补齐动作链', commit: '待修复' },
  { id: 'yy0-003', source: 'yy0', module: '投标文件上传', page: 'BidUpload', severity: 'P0', issue: '提示正式提交必须 CA 加密，但允许密码加密进入提交结果，规则矛盾', status: '未修复', fix: '需按 fix-review-issues-20260714 提案区分 CA/密码加密', commit: '待修复' },
  { id: 'yy0-004', source: 'yy0', module: '投标文件上传', page: 'BidUpload', severity: 'P1', issue: '缺少投标文件与招标文件评审条款关联功能', status: '未修复', fix: '需新增条款关联面板', commit: '待修复' },
  { id: 'yy0-005', source: 'yy0', module: '专家任务', page: 'ExpertProject / 新增页面', severity: 'P1', issue: '缺少专家抽取、授权、通知、接收任务链路', status: '未修复', fix: '需新增 ExpertTasks 专家任务中心', commit: '待修复' },
  { id: 'yy0-006', source: 'yy0', module: '开标大厅', page: 'OpeningHall', severity: 'P2', issue: '步骤文案写“专家签到”但签到表没有专家，对象不一致', status: '未修复', fix: '需同步步骤文案与签到表对象', commit: '待修复' },
  { id: 'yy0-007', source: 'yy0', module: '文件版本', page: 'TenderDoc / Downloads / ExpertProject', severity: '待确认', issue: '三处页面文件版本未体现统一版本链', status: '未修复', fix: '需新增统一文件版本 store', commit: '待修复' },
  { id: 'yy0-008', source: 'yy0', module: '项目创建/报价', page: 'ProjectCreate / BidUpload', severity: 'P1', issue: '报价字段固定，未继承前半段项目/标段配置', status: '未修复', fix: '需配置报价字段模板并继承到报价页', commit: '待修复' },
  { id: 'yy0-009', source: 'yy0', module: '招标文件/评标', page: 'TenderDoc / ExpertProject', severity: 'P1', issue: '专家评分页维度固定，未由评标办法配置驱动', status: '未修复', fix: '需评标办法配置评分项/权重并驱动评分页', commit: '待修复' },
