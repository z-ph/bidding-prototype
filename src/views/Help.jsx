...
const helpItems = [
  ...
  },
  {
    ...
    children: (
      <>
        <p><strong>Q：如何参与项目投标？</strong></p>
        <p>A：供应商完成入库审核后无需报名。使用供应商账号登录，在“项目中心”找到目标项目，直接下载招标文件并编制投标文件；邀请招标项目需收到邀请后方可参与。</p>
        <p><strong>Q：投标文件如何上传？</strong></p>
        <p>A：进入“我参与的项目”，选择对应项目点击“上传投标文件”，使用CA证书签章后提交。</p>
  ...
  },
  {
    ...
    children: (
      <>
        ...
        <p><strong>Q：中标后需要缴纳哪些费用？</strong></p>
        <p>A：按平台口径，投标阶段不缴纳保证金和文件费；采购结果发布后，由中标人线下缴纳投标费用，招标人/代理在“费用台账”登记凭证。</p>
      </>
    )
  },
  {
