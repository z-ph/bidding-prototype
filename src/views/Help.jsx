...
const helpItems = [
  {
    ...
    children: (
      <>
        ...
        <p>A：目前支持公开采购、邀请采购、公开询比、竞争性谈判、邀请询比等多种采购方式。</p>
      </>
    )
  },
  {
    ...
    children: (
      <>
        <p><strong>Q：如何参与项目响应？</strong></p>
        <p>A：供应商完成入库审核后无需报名。使用供应商账号登录，在“项目中心”找到目标项目，直接下载采购文件并编制响应文件；邀请采购项目需收到邀请后方可参与。</p>
        <p><strong>Q：响应文件如何上传？</strong></p>
        <p>A：进入“我参与的项目”，选择对应项目点击“上传响应文件”，使用CA证书签章后提交。</p>
        <p><strong>Q：开启时需要做什么？</strong></p>
        <p>A：在指定时间进入“开启大厅”，完成身份认证后即可在线解密、确认报价并查看开启记录。</p>
      </>
    )
  },
  {
    ...
    children: (
      <>
        ...
        <p><strong>Q：中选后需要缴纳哪些费用？</strong></p>
        <p>A：按平台口径，响应阶段不缴纳保证金和文件费；采购结果发布后，由中选人线下缴纳响应费用，采购单位/代理在“费用台账”登记凭证。</p>
      </>
    )
  },
  {
  ...
  },
  {
    ...
    children: (
      <>
        ...
        <p>地址：XX市XX区公共资源交易中心 3 楼电子采购服务窗口</p>
      </>
    )
  }
]
