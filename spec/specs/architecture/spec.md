...
<!-- Merged from migrate-vue-to-react / architecture -->
...
<!-- MODIFIED 需求「UI 组件库」在 living spec 中无同名需求，按规则追加并注明 -->
...
<!-- Removed 2026-07-17: 「Vue 单文件组件」— migrate-vue-to-react 迁移后不再使用 .vue 文件及 Vue 的 ref/reactive/computed/watch 等响应式 API；本 capability 为新建 living spec，无既有需求块可删除，以本注释记录该移除口径 -->
